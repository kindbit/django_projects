# Generated by Django 3.0.2 on 2021-02-26 04:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ad',
            name='gender',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='adpet.Gender'),
        ),
        migrations.AddField(
            model_name='ad',
            name='owner',
        ...
        migrations.AddField(
            model_name='ad',
            name='size',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='adpet.Size'),
        ),
        migrations.AddField(
            model_name='ad',
            name='specie',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='adpet.Specie'),
        ),
        migrations.AddField(
            model_name='ad',
            name='sterilized',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='adpet.Sterilized'),
        ),
        migrations.AddField(
            model_name='ad',
            name='vaccinated',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='adpet.Vaccinated'),
        ),
        migrations.CreateModel(
            name='Fav',
            fields=[
